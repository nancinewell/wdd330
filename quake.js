import { getJSON } from './quake-utilities.js';
...
export default class Quake {
    ...
    async getEarthQuakesByRadius(position, radius = 100) {
        ...
        let newURL = this.baseUrl + `&latitude=${position.coords.latitude}&longitude=${position.coords.longitude}&maxradiuskm=${radius}`;
        this._quakes.push(getJSON(newUrl));
        return this._quakes;
    }
    getQuakeById(id) {
